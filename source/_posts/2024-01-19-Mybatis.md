...
3. 准备Mapper接口和MapperXML文件
   ...
   ![](http://cdn.this0.com/blog/img/image_pikdpXSaNV.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=6beAOP9916EH4Y+J8QhRaU/fqJo=&x-oss-process=style/cdn.this0)
...
6. SqlSession和HttpSession区别
   ...
   -   SqlSession：不依赖Web服务器，属于持久化层。
       -   代表Java程序和数据库之间的会话。
           ![](http://cdn.this0.com/blog/img/image_nCsKIKFBM7.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=QQW5Dlpe+izg1u/S/gV8FW/V3nU=&x-oss-process=style/cdn.this0)
...
![](http://cdn.this0.com/blog/img/image_Sd6pCEE6Oi.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=Sig7yHMQ+kXfvFBsBVphAIweY+o=&x-oss-process=style/cdn.this0)

#### 2.1.3 **\${}形式**

\${}形式传参，底层Mybatis做的是字符串拼接操作。

![](http://cdn.this0.com/blog/img/image_KYrG3XT73t.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=KA7nwbaWcY8h+QtlumGEoWkCNJg=&x-oss-process=style/cdn.this0)
...
![](http://cdn.this0.com/blog/img/img005.ebd8c6a3.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=BeaXjHwIhvqRHJUqF3Dxz4MRtdM=&x-oss-process=style/cdn.this0)
...
![](http://cdn.this0.com/blog/img/img006.f9958c52.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=sbzNFJ5V5EsvAj7/N2Gd07x5+Ys=&x-oss-process=style/cdn.this0)
...
3. OrderMapper.xml配置文件
   ...
   ![](http://cdn.this0.com/blog/img/img018.6c3cfc17.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=Dayb45pdKDmEgXHibtU1bwLBBT8=&x-oss-process=style/cdn.this0)
...
3. CustomerMapper.xml文件
   ...
   ![](http://cdn.this0.com/blog/img/img019.dba418c1.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=HCaiCqYT2WXaJ31eIgKiO/iCfBM=&x-oss-process=style/cdn.this0)
...
![](http://cdn.this0.com/blog/img/image_UTL-tjGuzm.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=LarODnd8U2RUbEMktj+zkr51Wvk=&x-oss-process=style/cdn.this0)
...
- Mapper 配置文件放在 Mapper 接口所在的包内
  ...
  - 可以在sources下创建mapper接口包一致的文件夹结构存放mapperxml文件
    ...
    ![](http://cdn.this0.com/blog/img/image_ehqr6FrNXV.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=HHfrwvHBOeMZ2bxwM2rypW2RUeg=&x-oss-process=style/cdn.this0)

    ![](http://cdn.this0.com/blog/img/image_PhqgFRgNDi.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=R5vAnMJOzdODKea7nrJ/615hKfw=&x-oss-process=style/cdn.this0)
...
2. 使用 IntelliJ IDEA连接数据库
   ...
   - 连接数据库
     ...
     ![](http://cdn.this0.com/blog/img/image_yKs2Z2_8sQ.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=+yqzEak9ARD/E/bCTmj+ZoGf/vc=&x-oss-process=style/cdn.this0)

   - 填写信息

     ![](http://cdn.this0.com/blog/img/image_bDboqlZFKD.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=40mikz2fkP+aJ84fo2RZ87U0lck=&x-oss-process=style/cdn.this0)

   - 展示库表

     ![](http://cdn.this0.com/blog/img/image_mCMuBhwZl2.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=WIgQsPfsnWmW98C7/e7yToHeeXQ=&x-oss-process=style/cdn.this0)

   - 逆向工程使用

     ![](http://cdn.this0.com/blog/img/image_DkwlIx_BM9.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=d64mxG9cpdA+WTzlxBd2QhBUiNI=&x-oss-process=style/cdn.this0)

     ![](http://cdn.this0.com/blog/img/image_dJvZP76xYm.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=TJW5G0PMq3sKHHn8sIgL4wLPzf4=&x-oss-process=style/cdn.this0)

     ![](http://cdn.this0.com/blog/img/image_KXYfK5CQd-.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=1ri/nLK5uQE2sidZYrIVd0X1b3Q=&x-oss-process=style/cdn.this0)

3. 查看生成结果

   ![](http://cdn.this0.com/blog/img/image_IIK2v1Lk64.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=QXkWjC8YbhHd8AP4a6fizTKxXQE=&x-oss-process=style/cdn.this0)
