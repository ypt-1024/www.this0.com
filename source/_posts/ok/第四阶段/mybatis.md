...
![image-20240307010620112](https://blog-resources.this0.com/image/202405112003394.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003311.png?x-oss-process=style/this0-blog)
...
2. 项目搭建和准备
   ...
   1. 项目搭建
      ...
      ![](https://blog-resources.this0.com/image/202405112003273.png?x-oss-process=style/this0-blog)
...
3. 准备Mapper接口和MapperXML文件
   ...
   ![](https://blog-resources.this0.com/image/202405112003258.png?x-oss-process=style/this0-blog)
...
7. SqlSession和HttpSession区别

   -   HttpSession：工作在Web服务器上，属于表述层。
       -   代表浏览器和Web服务器之间的会话。
   -   SqlSession：不依赖Web服务器，属于持久化层。
       -   代表Java程序和数据库之间的会话。
           ![](https://blog-resources.this0.com/image/202405112003292.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003288.png?x-oss-process=style/this0-blog)

#### 2.1.3 **\${}形式**

\${}形式传参，底层Mybatis做的是字符串拼接操作。

![](https://blog-resources.this0.com/image/202405112003435.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003715.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003070.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003544.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003742.png?x-oss-process=style/this0-blog)
...
3. OrderMapper.xml配置文件
   ...
   ![](https://blog-resources.this0.com/image/202405112003943.png?x-oss-process=style/this0-blog)
...
3. CustomerMapper.xml文件
   ...
   ![](https://blog-resources.this0.com/image/202405112003440.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003546.png?x-oss-process=style/this0-blog)
...
![](https://blog-resources.this0.com/image/202405112003035.png?x-oss-process=style/this0-blog)
...
- Mapper 配置文件放在 Mapper 接口所在的包内
  ...
  - 可以在sources下创建mapper接口包一致的文件夹结构存放mapper.xml文件
    ...
    ![](https://blog-resources.this0.com/image/202405112003412.png?x-oss-process=style/this0-blog)

    ![](https://blog-resources.this0.com/image/202405112003253.png?x-oss-process=style/this0-blog)
...
2. mybatis-config.xml配置分页插件
   ...
   其中，`com.github.pagehelper.PageInterceptor` 是 PageHelper 插件的名称，`value` 属性用于指定数据库类型（支持多种数据库）
...
常见的`半自动 ORM 框架包括 MyBatis` 等；常见的全自动 ORM 框架包括 Hibernate、Spring Data JPA、`MyBatis-Plus` 等。
...
2. 使用 IntelliJ IDEA连接数据库
   ...
   - 连接数据库
     ...
     ![](https://blog-resources.this0.com/image/202405112003457.png?x-oss-process=style/this0-blog)

   - 填写信息

     ![](https://blog-resources.this0.com/image/202405112003389.png?x-oss-process=style/this0-blog)

   - 展示库表

     ![](https://blog-resources.this0.com/image/202405112003652.png?x-oss-process=style/this0-blog)

   - 逆向工程使用

     ![](https://blog-resources.this0.com/image/202405112003724.png?x-oss-process=style/this0-blog)

     ![](https://blog-resources.this0.com/image/202405112003213.png?x-oss-process=style/this0-blog)

     ![](https://blog-resources.this0.com/image/202405112003480.png?x-oss-process=style/this0-blog)

3. 查看生成结果

   ![](https://blog-resources.this0.com/image/202405112003594.png?x-oss-process=style/this0-blog)
