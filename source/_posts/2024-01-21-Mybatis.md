...
3. 准备Mapper接口和MapperXML文件
   ...
   2. 定义mapper xml
      ...
      //TODO 之所以写成：emp_id empId,emp_name empName, emp_salary empSalary，是为了数据库和实体形成映射
...
通过给数据库表字段加别名，让查询结果的每一列都和Java实体类中属性对应起来。//TODO前面已经说过了
...
1. 别名对应
   ...
   将字段的别名设置成和实体类属性一致。//TODO，第三次出现类似的了
...
3. OrderMapper.xml配置文件
   ...
   `//TODO，id属性：通常设置为这个resultMap所服务的那条SQL语句的id加上“ResultMap”，也就是方法名加上ResultMap`
