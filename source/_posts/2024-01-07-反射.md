...
方案1：`在编译和运行时都完全知道类型的具体信息`，在这种情况下，我们可以直接先使用运算符进行判断，再利用`强制类型转换符将其转换成运行时类型的变量即可`。instanceof

方案2：编译时根本`无法预知该对象和类的真实信息`，程序只能依靠`反射`来发现该对象和类的真实信息，这就必须使用反射。运行时信息
...
![image-20220524101441695.png](http://cdn.this0.com/blog/img/1681282231749-56e0cc4c-c76c-4953-9355-ed69160782ae.png)
...
###  3.反射机制-类的加载过程与类加载器的理解//TODO,暂时没看

#### 1. 类的加载与ClassLoader的理解

##### 1.1 类的生命周期	//TODO要记吗？

类在内存中完整的生命周期：`加载-->使用-->卸载`。其中`加载过程又分为：装载、链接、初始化三个阶段。`

//TODO下图应该是装载

![image-20220417173459849.png](http://cdn.this0.com/blog/img/1681282363292-1bda9754-9606-42ca-a4aa-6f1b22351197.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=2LwMPTVLVE8SUn2hQBGNPQLYCSg=&x-oss-process=style/cdn.this0)
...
![image-20220417171411631.png](http://cdn.this0.com/blog/img/1681282430523-fd471439-fd91-4f8b-8812-1ff6323a7a49.png)
...
![image-20220417173647473.png](http://cdn.this0.com/blog/img/1681282457230-b783ba0e-d7d6-4d31-99c0-18a4e2e667f7.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=hzAzLPeS7o5c7pf4N6H285qMnG4=&x-oss-process=style/cdn.this0)
...
![image-20220417173616344.png](http://cdn.this0.com/blog/img/1681282480062-d51c29f3-5f64-4a3f-9b8a-13d9cf1d5f48.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=/NKwgtajDYRAQA/VRdMUW3yHJjI=&x-oss-process=style/cdn.this0)
...
![image-20220417173819953.png](http://cdn.this0.com/blog/img/1681282513816-07ed9b91-255a-4aff-b3f6-76301876eaec.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=APawt4c9WXRA0H5iuzPpy5tuYV8=&x-oss-process=style/cdn.this0)
...
![image-20220417174032702.png](http://cdn.this0.com/blog/img/1681282546460-ee82f3a9-1fb7-4b65-bcfe-ff22d9df7ba0.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=XhQUgn4YZ8fr6RbyR1obaAoCZqQ=&x-oss-process=style/cdn.this0)
...
##### 1.2 调用指定的方法![image-20220417181700813.png](http://cdn.this0.com/blog/img/1681282597231-ed96b21a-f199-40a3-94b5-553b5f79e6b4.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000000&Signature=3lW3hAlIHeKKzxtRh/7cDqgTyJo=&x-oss-process=style/cdn.this0)
...
##### 2.1 声明自定义注解		//TODO，自定义注解，以前出现过。第二次出现
