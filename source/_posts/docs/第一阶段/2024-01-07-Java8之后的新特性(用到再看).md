...
- 语法层面：
  ...
  - 比如`JDK8中的lambda表达式`、接口中的默认方法、静态方法
  - 比如JDK10中局部变量的类型推断
  - 比如JDK12中的switch
  - 比如JDK13中的文本块
- API层面：
  ...
  - 新的 / 过时的 API
- 底层优化
  - 比如JDK8中`永久代被元空间`替代、新的JS执行引擎
  - 比如新的垃圾回收器、GC参数、JVM的优化

### `2.lambda 表达式的使用与函数式接口的理解`
...
```
package com.this0.java2; /**  * @author 尚硅谷-宋红康 邮箱：shkstart@126.com  */public class Employee {
         private int id;
         private String name;
         private int age;
         private double salary;
...
//		System.out.println(opt.get());//java.util.NoSuchElementException: No value present
    ...
    public void test6(){
        String str = "hello";
        Optional<String> opt = Optional.ofNullable(str);
        String string = opt.orElse("this0");
        System.out.println(string);
    }
    @Test
    public void test7(){
...
###  `7.JDK8-17 新特性-第 18 章复习与企业真题_最后寄语`  
