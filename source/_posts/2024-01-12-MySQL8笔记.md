...
![1656836506624](http://cdn.this0.com/blog/img/1656836506624.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=rKcV6GKZVAR9gfgKrByYB2RUGkM=&x-oss-process=style/cdn.this0)
...
<img src="http://cdn.this0.com/blog/img/1680058707816.png" />

### 2.2.利用点击去还原

范式（2NF）必须先满足第一范式（1NF）。第二范式（2NF）要求数据库表中的每个实例或行必须可以被惟一的区分。为实现区分通常需要为表加上一个列，以存储各个实例的惟一标识。
...
![](http://cdn.this0.com/blog/img/tu_11.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=bcoV/BJDFgTz/wSwx65jYXWjK80=&x-oss-process=style/cdn.this0)
...
![1656810874952](http://cdn.this0.com/blog/img/1656810874952.png)
...
![1656811180664](http://cdn.this0.com/blog/img/1656811180664.png?OSSAccessKeyId=LTAI5tAje5MhbPSKCC6QdGZb&Expires=9000000001&Signature=//3cPRTu3nx1jN1e5btpj+zA4J8=&x-oss-process=style/cdn.this0)
